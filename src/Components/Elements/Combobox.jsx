    ...
    <div className="w-full relative">
      <Combobox value={selected} onChange={changeHandle}>
        <div className="relative z-[9999999">
          <div className="relative w-full cursor-default overflow-hidden rounded-xl text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm p-2 border border-color_border_70">
            <Combobox.Input
      ...
      <span
        className={`absolute left-3 font-bold
             text-textSecond_300 top-[-8px] z-10 text-[0.80rem] font-bold"
         
          bg-background_body pl-2 pr-2`}
      >
        {label}
      </span>
    </div>
