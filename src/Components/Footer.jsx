...
function Footer() {
  return (
    <div className="text-color_text_20 font-bold bg-background_body dark:bg-background_body_dark text410  dark:text-white fixed bottom-0 left-0 w-full h-[29px] text-[11px] ">
