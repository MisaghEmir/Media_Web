...
function BigNews() {
  return (
    <div>
      <div>
        <img src="./image/test/1.avif" className="w-full rounded-md" alt="" />
      </div>
      <div className="mt-3">
        <small className="text-color_text_23">SAUDI ARABIA</small>
        <h3 className="text-4xl font-AcuminProBold">All that glitters in the Saudi League is not gold</h3>
