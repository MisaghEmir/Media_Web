...
function Header({styk}) {
  ...
  return (
    <nav
      className={`${styk ? 'text-white font-AcuminProBold border-color_border_50' : 'text-black border-color_border_70  dark:text-white' } z-30 header text11 sticky top-0 border-b  dark:border-color_border_40 flex content-center justify-between px-8  pb-[2px] text-sm items-center ${
    ...
    >
      ...
      <div className=" flex-1 flex items-center  ">
        ...
        >
          <li className={`pt-1 m-0  border-l  dark:border-color_border_40 pl-4 ${styk ? 'border-color_border_60' : ' border-color_border_70  ' }`}>
...
function Left() {
  ...
  return (
    ...
    >
      ...
      <li className="pt-4 m-0 hidden md:block  h-full pb-3">
    ...
    <div>
      ...
      >
        ...
        <li className="pt-0 m-0">
          <Link to={"/login"}>
            <button className={`w-24 text-center dark:border-color_border_40 justify-center font-bold rounded-full hidden md:flex border text-[14px]  px-5 py-1 pt-2 ${styk ? 'border-color_border_60' : ' border-color_border_70  ' }`}>
              Log in
            </button>
          </Link>
        </li>
